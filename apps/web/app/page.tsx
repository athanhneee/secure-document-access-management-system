    ...
    <div className="site-shell">
      ...
      <header className="site-header">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="rounded-md border border-slate-700 bg-slate-900/80 px-3 py-1 text-xs font-medium text-slate-200 hover:bg-slate-800 transition-colors"
          >
            Đăng nhập
          </Link>
        ...
        <section className="hero" aria-labelledby="page-title">
          <div className="hero-copy">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <Link
                className="inline-flex items-center justify-center rounded-lg bg-emerald-600 px-4 py-2 text-xs font-semibold text-white shadow-lg hover:bg-emerald-500 transition-colors"
                href="/login"
              >
                Đăng nhập hệ thống
              </Link>
              <Link className="text-link inline-flex items-center gap-1" href="/admin">
                <span>Mở không gian quản trị</span>
